...
export const Input = ({
  ...
  return (
    <input
      ...
      className={`w-full text-sm rounded-sm px-4 py-2 bg-slate-50 border focus:outline-none ${className}`}
...
export const InputGroup = ({
  ...
  return (
    <div className="w-full flex flex-col gap-1 my-2">
      <strong className="text-sm font-bold text-black">{label}</strong>
